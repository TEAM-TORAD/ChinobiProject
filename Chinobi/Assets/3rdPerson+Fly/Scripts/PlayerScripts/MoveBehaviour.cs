...
public class MoveBehaviour : GenericBehaviour
{
	...
	public string attackButton = "Fire1";           // Default Mouse 1
	public string blockButton = "Fire2";            // Default Mouse 2
	public string kickButton = "Fire3";				// Default Mouse 3
	...
	void Update()
	{
		...
		if (jump)
		{
			//Front flip by double tapping jump
		...
		//Reset and Remove Bools for Animator
		...
		if (Input.GetButtonUp(kickButton))
		{
