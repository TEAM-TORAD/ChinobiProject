...
public class WheelTurner : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            s.startAngle = s.statue.localRotation;
        }
    ...
    void LateUpdate()
    {
        ...
        Quaternion newPosTarget = Quaternion.Lerp(targets[target].statue.localRotation, newTargetPos, targetTurnSpeedPerSec);
    ...
    public void NextStatue()
    {
        ...
        targets[target].startAngle = targets[target].statue.localRotation;
